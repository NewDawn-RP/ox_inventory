...
return {
	General = {
		...
		blip = {
			...
			{ loc = vec3(25.06, -1347.32, 29.5), length = 0.8, width = 0.8, heading = 0.0, minZ = 29.5, maxZ = 31.9, distance = 4.5 },
			{ loc = vec3(-705.73, -914.91, 18.22), length = 0.8, width = 0.8, heading = 89.21, minZ = 18.22, maxZ = 20.22, distance = 4.5 },
			{ loc = vec3(-1222.82, -908.94, 11.32), length = 0.8, width = 0.8, heading = 36.64, minZ = 11.32, maxZ = 13.32, distance = 4.5 },
			{ loc = vec3(-46.65, -1757.91, 28.42), length = 0.8, width = 0.8, heading = 59.03, minZ = 28.42, maxZ = 30.42, distance = 4.5 },
			{ loc = vec3(1134.08, -982.72, 45.41), length = 0.8, width = 0.8, heading = 277.21, minZ = 45.41, maxZ = 48.41, distance = 4.5 },
			{ loc = vec3(1165.02, -323.87, 68.20), length = 0.8, width = 0.8, heading = 98.01, minZ = 68.20, maxZ = 70.20, distance = 4.5 },
			{ loc = vec3(-1486.57, -377.62, 39.16), length = 0.8, width = 0.8, heading = 134.32, minZ = 39.16, maxZ = 41.16, distance = 4.5 },
			{ loc = vec3(-1819.10, 793.05, 137.08), length = 0.8, width = 0.8, heading = 124.87, minZ = 137.08, maxZ = 139.08, distance = 4.5 },
			{ loc = vec3(-2966.35, 391.30, 14.04), length = 0.8, width = 0.8, heading = 85.08, minZ = 14.04, maxZ = 16.04, distance = 4.5 },
			{ loc = vec3(-3040.79, 583.97, 6.90), length = 0.8, width = 0.8, heading =20.30, minZ = 6.90, maxZ = 8.90, distance = 4.5 },
			{ loc = vec3(373.13, 326.29, 103.57), length = 0.8, width = 0.8, heading = 345.0, minZ = 103.57, maxZ = 105.57, distance = 4.5 },	
			{ loc = vec3(-3244.24, 1000.17, 11.83), length = 0.8, width = 0.8, heading = 356.37, minZ = 11.83, maxZ = 13.83, distance = 4.5 },
			{ loc = vec3(549.30, 2669.45, 41.15), length = 0.8, width = 0.8, heading = 92.10, minZ = 41.15, maxZ = 43.15, distance = 4.5 },
			{ loc = vec3(2676.40, 3280.25, 54.24), length = 0.8, width = 0.8, heading = 331.44, minZ = 54.24, maxZ = 56.24, distance = 4.5 },
			{ loc = vec3(1959.10, 3741.63, 31.34), length = 0.8, width = 0.8, heading = 299.68, minZ = 31.34, maxZ = 33.34, distance = 4.5 },
			{ loc = vec3(1696.90, 4923.60, 41.06), length = 0.8, width = 0.8, heading = 322.80, minZ = 41.06, maxZ = 43.06, distance = 4.5 },
			{ loc = vec3(1728.71, 6417.05, 34.03), length = 0.8, width = 0.8, heading = 248.71, minZ = 34.03, maxZ = 36.03, distance = 4.5 },
			{ loc = vec3(1728.71, 2710.78, 37.15), length = 0.8, width = 0.8, heading = 181.67, minZ = 37.15, maxZ = 39.15, distance = 4.5 },	
			{ loc = vec3(1392.9249, 3606.4197, 34.9809), length = 0.8, width = 0.8, heading = 198.4602, minZ = 34.15, maxZ = 36.15, distance = 4.5 },
			{ loc = vec3(161.9470, 6642.4878, 31.6989), length = 0.8, width = 0.8, heading = 221.7682, minZ = 31.15, maxZ = 34.15, distance = 4.5 },	
		},
	},
    ...
    PoliceArmoury = {
		...
		blip = {
            ...
            { name = 'lightkevlar', price = 300,metadata = {['drawableId'] = 4, ['textureId'] = 0, ['paletteId'] = 0, ['label'] = "Gilet Léger SAST"} },
            { name = 'mediumkevlar', price = 500, metadata = {['drawableId'] = 20, ['textureId'] = 0, ['paletteId'] = 0, ['label'] = "Gilet Moyen SAST"} },
            { name = 'heavykevlar', price = 750,  metadata = {['drawableId'] = 25, ['textureId'] = 0, ['paletteId'] = 0, ['label'] = "Gilet Lourd SAST"} },
	...
	Medicine = {
		...
		blip = {
		...
		}, targets = {
			{
                ...
                scenario = 'WORLD_HUMAN_STAND_IMPATIENT_UPRIGHT',
                loc = vec3(1102.2284, -1528.3562, 35.0326),
                heading = 179.3315,
            },
		}
	},
