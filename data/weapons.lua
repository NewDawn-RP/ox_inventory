return {
	Weapons = {
		...
		['WEAPON_COMBATMG_MK2'] = {
			label = 'Mittrailleuse de Combat MK2',
			weight = 8000,
			durability = 0.02,
			ammoname = 'ammo-assaut'
		},
		...
		['WEAPON_COMBATPDW'] = {
			label = 'Arme de Défense Personnelle (ADP)',
			weight = 2300,
			durability = 0,
			ammoname = 'ammo-pistol'
		},
		...
		['WEAPON_COMPACTLAUNCHER'] = {
			label = 'Lanceur de Grenade Comptacte',
			weight = 80000,
			durability = 0,
		...
		['WEAPON_COMPACTRIFLE'] = {
			label = "Fusil d'Assault Compacte",
			weight = 15000,
			durability = 0,
			ammoname = 'ammo-assaut'
		},
		...
		['WEAPON_FLARE'] = {
			label = 'Fusée Eclairante',
			weight = 250,
			throwable = true,
		},

		['WEAPON_FLAREGUN'] = {
			label = 'Lanceur de Fusée Eclairante',
			weight = 1000,
			durability = 0,
			ammoname = 'ammo-flare'
		},
		...
		['WEAPON_MARKSMANRIFLE_MK2'] = {
			label = "Fusil d'Assault d'Elite MK2",
			weight = 15000,
			durability = 0,
			ammoname = 'ammo-assaut'
		},
		...
		['WEAPON_MILITARYRIFLE'] = {
			label = "Fusil d'Assault Militaire",
			weight = 15000,
			durability = 0,
			ammoname = 'ammo-assaut'
		},
		...
		['WEAPON_PETROLCAN'] = {
			label = "Jerrycan d'essence",
			weight = 12000,
		},

		['WEAPON_GADGETPISTOL'] = {
			label = 'Pistolet de Perico',
			weight = 5000,
			durability = 0,
			ammoname = 'ammo-pistol'
		},
		...
		['WEAPON_TACTICALRIFLE'] = {
			label = "Fusil de Sniper Tactique",
			weight = 15000,
			durability = 0,
			ammoname = 'ammo-assaut'
		},
	...
	Ammo = {
		['ammo-assaut'] = {
			label = 'Munition Perforante',
			weight = 19,
		},

		['ammo-pistol'] = {
			label = 'Munition Legere',
			weight = 3,
		},
